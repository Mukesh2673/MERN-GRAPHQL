...
import {publicFile,agents,users, plateForm} from "../schema"
import { Pool } from 'pg';
import 'dotenv/config';


export const users1 = pgTable('plateForms', {
    first_name:text('first_name'),
 });

export type Agent =InferModel<typeof agents>; 
export type NewAgent=InferModel<typeof agents,'insert'>;
export type plateForm=InferModel<typeof plateForm>;
export type NewPlateForm=InferModel<typeof plateForm ,'insert'>;
...
export const createPlateForms=async(data:NewPlateForm)=>{
  try{
